...
import { 
  LayoutDashboard, BarChart2, TrendingUp, Zap, History, Layers, 
  PieChart, Star, Receipt, Bell, Filter, Newspaper, Settings, HelpCircle
} from "lucide-react";
...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Options Chain", href: "/options", icon: Layers },
    ]
  },
  {
    title: "PORTFOLIO",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "News & Research", href: "/news", icon: Newspaper },
    ]
  },
  {
    title: "ACCOUNT",
    ...
    <aside className="w-[240px] flex-shrink-0 flex flex-col h-screen bg-[#080E19] border-r border-white/5 overflow-hidden font-sans z-50 transition-all duration-300">
      ...
      <div className="p-4 border-t border-white/5 bg-[#060B14]">
        <div className="flex items-center justify-between text-xs font-medium bg-[#0F1928] p-2.5 rounded-lg border border-white/5">
          <div className="flex items-center gap-2 text-[#00D4AA] font-bold uppercase tracking-wider">
            <div className="w-1.5 h-1.5 rounded-full bg-[#00D4AA] animate-pulse shadow-[0_0_5px_#00D4AA]"></div>
            NSE Live
          </div>
